...
public class ColoredTextView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final int CORNER_RADIUS = (int) UiUtils.INSTANCE.dip2px(4);
    private static final int X_PADDING = (int) UiUtils.INSTANCE.dip2px(16);
    private static final int Y_PADDING = (int) UiUtils.INSTANCE.dip2px(8);
